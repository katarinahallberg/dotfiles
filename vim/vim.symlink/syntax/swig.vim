...
syn region  swgPartial         start=/{%(\s+)?(include|partial)/lc=2 end=/%}/me=e-2        containedin=swgInside

syn match   swgConditionals    "if\|else\|elseif\|endif"         containedin=swgInside
syn match   swgHelpers         "for\|endfor\|partial\|include"   containedin=swgInside
